...
author: "Jack Goodall"
date: "Started 01-09-2024, rendered `r format(Sys.Date(), '%d-%m-%Y')`"
output:
  html_document:
    css: setup/style.css
    includes:
...
The code used to make this page can be found on my GitHub [here](https://github.com/jackwgoodall/floreytemplate/blob/main/example_markdown.Rmd).  

This html file is both a demonstration of what can be done and as well as being available to download for you to make your own markdown documents.
...
This might be all you need to get going, otherwise having the source code to cross reference as you read through the webpage should help you understand how it was all put together. This can be downloaded [here]
...
I have set up the css file (this is [explained later](#custom-css) to give a bit of extra white space above and below the headings; these can be easily changed.
