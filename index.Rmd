...
This page is a tutorial on how to use Rmarkdown made for Sheffield's [Florey Institute](https://www.sheffield.ac.uk/florey-institute) (although everyone is of course welcome to use and adapt it). 

The tutorial is aimed at people who are already familiar with R but are new to R markdown.  It aims to give those people both introduction to this powerful communication tool, and to give a flavour of how it might be used to communicate pre-publication research findings with colleague and collaborators.  
